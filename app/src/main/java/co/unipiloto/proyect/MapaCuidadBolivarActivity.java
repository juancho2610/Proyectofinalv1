...
public class MapaCuidadBolivarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mapa_cuidadbolivar_activity);
        ...
        toolbar = findViewById(R.id.toolbar_CUIDADBOLIVAR);
